...
func _load_item_definitions() -> void:
    ...
    _add_weapon("hunter_bow", "Hunter's Bow", ItemType.BOW, [0,1,2], 0, 6, 14, -5, 11, 0, 0, [2,4], true, 2, 4)
    ...
    _add_armor("war_boots", "War Boots", ItemType.BOOTS, [0,1,2], 10, 0, 0, 0, 16, 0, 0, [0,1], 2, 2)
...
func _add_ring_amulet(id: String, name: String, type: ItemType, rarities: Array, rlvl: int, rstr: int, rdex: int):
    _add_weapon(id, name, type, rarities, 0, 0, 0, 0, rlvl, rstr, rdex, [], false, 1, 1)
